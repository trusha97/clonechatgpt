...
export default function StudyButton() {
  ...
  return (
    <div
      className={`inline-flex h-9 rounded-full border text-[13px] font-medium 
      border-token-border-default 
      focus-visible:outline-black dark:focus-visible:outline-white
      ${isPressed ? "bg-black/10" : ""}`}
    >
      <button
        className="flex h-full min-w-8 items-center justify-center p-2 text-[#5D5D5D] hover:text-[#3d3d3d] transition-colors"
        data-testid="composer-button-study"
      ...
      >
        <svg
          ...
          className="h-[18px] w-[18px] text-[#5D5D5D] hover:text-[#3d3d3d] transition-colors"
        >
          <path
            fill="currentColor"
        ...
        <span className="ps-1 pe-1 whitespace-nowrap [[data-collapse-labels]_&]:sr-only">
          Study
        </span>
      </button>
    </div>
