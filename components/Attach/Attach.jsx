...
const Attach = () => {
  ...
  return (
    <div
      ...
      style={{ viewTransitionName: "var(--vt-composer-attach-file-action)" }}
    >
      <div className="relative">
        <span className="flex" data-state={isOpen ? "open" : "closed"}>
          <div
            className="flex"
            type="button"
            id="radix-_r_b6_"
          ...
          >
            <button
              ...
              className="flex items-center justify-center h-9 rounded-full border border-gray-300 min-w-8 w-auto px-2 text-[13px] font-semibold text-[#5D5D5D] hover:bg-gray-100 transition-colors duration-200"
              onClick={toggleMenu}
            >
              <svg
                width="20"
              ...
              <span className="ps-1 pe-1 whitespace-nowrap text-[#5D5D5D]">
                Attach
              </span>
            </button>
          </div>
